...
class BaseTest(TestCase):
    ...
    def setUp(self):
        ...
        self.category_private = Category.objects.create(
            name="プライベート", user=self.user
        )
...
class TaskViewTest(BaseTest):
    ...
    def test_task_complete(self):
        ...
        response = self.client.post(
            reverse("task_complete", args=[self.task_active.pk])
        )
...
class CategoryViewTest(BaseTest):
    ...
    def test_category_create(self):
        ...
        response = self.client.post(
            reverse("category_create"), {"name": "新規カテゴリ"}
        )
    ...
    def test_category_update(self):
        ...
        response = self.client.post(
            reverse("category_update", args=[self.category_work.pk]),
            {"name": "Updated Work"},
        )
    ...
    def test_category_delete(self):
        ...
        response = self.client.post(
            reverse("category_delete", args=[self.category_work.pk])
        )
        # Assert: リダイレクトを確認
        self.assertRedirects(response, reverse("category_list"))
...
class TrashViewTest(BaseTest):
    ...
    def test_task_restore(self):
        ...
        response = self.client.post(
            reverse("task_restore", args=[self.task_deleted.pk])
        )
    ...
    def test_task_bulk_delete(self):
        ...
        response = self.client.post(
            reverse("task_bulk_delete"), {"task_ids": [self.task_deleted.pk]}
        )
        # Assert: ゴミ箱 (trash) にリダイレクトされたことを確認
        self.assertRedirects(response, reverse("trash"))
